...
TEST_F(RuleEngine_CONTEXT_KI_OSV_25_50, UdloebsalderPension_POSITIVE) {
	...
	ta.setValue(kUdloebsalder_Pension, (long) 60 );

	auto r = re.validate(ta, (unsigned short) kUdloebsalder_Pension);
...
TEST_F(RuleEngine_CONTEXT_KI_OSV_25_50, UdloebsalderPension_NEGATIVE) {
	TA ta { "15124040", 4}; // KonceptOid 4 - OSV
	ta.setValue(kUdloebsalder_Pension, (long) 61); // value not allowed
